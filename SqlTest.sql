...
INSERT INTO Worker  
     (WORKER_ID, FIRST_NAME, LAST_NAME, SALARY, JOINING_DATE, DEPARTMENT) VALUES
		(001, 'Satendra', 'Kumar', 500000, '14-02-20 09.00.00', 'HR'),
		(002, 'Nishant', 'Verma', 80000, '14-06-11 09.00.00', 'Admin'),
		(003, 'Vishal', 'Kumar', 400000, '14-02-20 09.00.00', 'HR'),
		(004, 'Piyush', 'Singh', 100000, '14-02-20 09.00.00', 'Admin'),
                (005, 'Vivek', 'Kumar', 700000, '14-06-11 09.00.00', 'Admin'),
		(006, 'Vipul', 'Sinha', 630000, '14-06-11 09.00.00', 'Account'),
		(007, 'Satish', 'Sahu', 62000, '14-01-20 09.00.00', 'Account'),
		(008, 'Geetika', 'khalkho', 20000, '14-04-11 09.00.00', 'Admin');
